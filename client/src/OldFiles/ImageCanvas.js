...
function ImageCanvas(props) {
    ...
    var handleMove = (e) => {
        ...
        //const canvasContext = canvas.getContext("2d");
        //const dimensions = calcDimensions();
        const dimensions = document.getElementById("canvasContainer").getBoundingClientRect();
    ...
    return(
        <canvas id="imageCanvas" ref={canvasRef} style={{backgroundColor:"rgb(200,200,200)"}}
